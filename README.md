...
![Supervised learning for AD progression prediction](Fig3.png=100x)
...
![Brain regions with AD-related effects for NC vs. sMCI and sMCI vs. pMCI cases](Fig4.png=100x)
...
![Brain regions with AD-related effects for NC vs. pMCI comparison](Suppl.Fig1.png=50x)
